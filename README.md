## Implicit Intents Receiver Classwork - Solution Code

An Implicit Activity Receiver is a simple app that is always activated from inside or outside to allow an Activity to receive an implicit Intent.
